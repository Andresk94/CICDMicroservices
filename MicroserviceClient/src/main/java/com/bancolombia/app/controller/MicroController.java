...
@RestController //Controlador Restfull que regresa un json los Restless regresan un XML
@RequestMapping("/client") //Indica cual es la ruta que quiero que usen para consumir mi micosrv http://ip:puerto/client
